// Copied from https://github.com/altcha-org/altcha/blob/main/dist/main/altcha.js
const DEV = false;
...
function injectCss(css2, id = "altcha-css", nonce) {
...
// Import other workers not bundled in main JS file
// https://altcha.org/docs/v2/widget-integration/#without-bundler-worker-import-support
$altcha.algorithms.set('ARGON2ID', () => new Worker('/altcha/workers/argon2id.js'));
$altcha.algorithms.set('SCRYPT', () => new Worker('/altcha/workers/scrypt.js'));